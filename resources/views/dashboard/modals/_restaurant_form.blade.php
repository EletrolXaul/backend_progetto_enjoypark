                            ...
                            <div class="opening-hours-container">
                                <div class="day-selector mb-2">
                                    <div class="btn-group w-100" role="group">
                                        <input type="checkbox" class="btn-check" id="day-lun" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-lun">Lun</label>
                                        <input type="checkbox" class="btn-check" id="day-mar" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-mar">Mar</label>
                                        <input type="checkbox" class="btn-check" id="day-mer" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-mer">Mer</label>
                                        <input type="checkbox" class="btn-check" id="day-gio" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-gio">Gio</label>
                                        <input type="checkbox" class="btn-check" id="day-ven" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-ven">Ven</label>
                                        <input type="checkbox" class="btn-check" id="day-sab" autocomplete="off"
                                            checked>
                                        <label class="btn btn-outline-primary btn-sm" for="day-sab">Sab</label>
                                        <input type="checkbox" class="btn-check" id="day-dom" autocomplete="off"
                                            checked>
                                ...
                                <div class="time-selector d-flex">
                                    <div class="me-2">
                                        ...
                                        <input type="time" class="form-control form-control-sm" id="opening_time"
                                            value="09:00">
                                    </div>
                                    <div>
                                        <label class="form-label small">Chiusura</label>
                                        <input type="time" class="form-control form-control-sm" id="closing_time"
                                            value="22:00">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="features-container">
                            <div class="feature-tags mb-2">
                                <div class="btn-group flex-wrap" role="group">
                                    ...
                                    <input type="checkbox" class="btn-check feature-checkbox" id="edit-feature-wifi"
                                        value="WiFi" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-wifi">WiFi</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-terrazza" value="Terrazza" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-terrazza">Terrazza</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-menu-bambini" value="Menu bambini" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-menu-bambini">Menu bambini</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-accessibile" value="Accessibile" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-accessibile">Accessibile</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-parcheggio" value="Parcheggio" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-parcheggio">Parcheggio</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-vegetariano" value="Opzioni vegetariane" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-vegetariano">Opzioni vegetariane</label>

                                    <input type="checkbox" class="btn-check edit-feature-checkbox"
                                        id="edit-feature-vegano" value="Opzioni vegane" autocomplete="off">
                                    <label class="btn btn-outline-secondary btn-sm m-1"
                                        for="edit-feature-vegano">Opzioni vegane</label>
                                </div>
                            </div>
                            <div class="custom-feature-input">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="edit-new-feature"
                                        placeholder="Aggiungi caratteristica...">
                                    <button class="btn btn-sm btn-outline-primary" type="button"
                                        id="edit-add-feature-btn">Aggiungi</button>
                                </div>
                            </div>
                        </div>
                ...
                <form id="editRestaurantForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_restaurant_name" name="name"
                                required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_restaurant_category" class="form-label">Categoria</label>
                            <input type="text" class="form-control" id="edit_restaurant_category" name="category"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_restaurant_cuisine" name="cuisine"
                                required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_restaurant_price_range" class="form-label">Fascia Prezzo</label>
                            <select class="form-control" id="edit_restaurant_price_range" name="price_range"
                                required>
                                <option value="€">€ - Economico</option>
                                <option value="€€">€€ - Medio</option>
                                <option value="€€€">€€€ - Costoso</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.1" min="1" max="5" class="form-control"
                                id="edit_restaurant_rating" name="rating" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_restaurant_opening_hours" class="form-label">Orario Apertura</label>
                            <input type="text" class="form-control" id="edit_restaurant_opening_hours"
                                name="opening_hours" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.000001" class="form-control"
                                id="edit_restaurant_location_x" name="location_x" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_restaurant_location_y" class="form-label">Posizione Y</label>
                            <input type="number" step="0.000001" class="form-control"
                                id="edit_restaurant_location_y" name="location_y" required>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_wifi" name="features[]"
                                        value="WiFi">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_parking"
                                        name="features[]" value="Parcheggio">
                                    <label class="form-check-label" for="edit_parking">Parcheggio</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_accessible"
                                        name="features[]" value="Accessibile">
                                    <label class="form-check-label" for="edit_accessible">Accessibile</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_outdoor"
                                        name="features[]" value="Posti all'aperto">
                                    <label class="form-check-label" for="edit_outdoor">Posti all'aperto</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_takeaway"
                                        name="features[]" value="Asporto">
                                    <label class="form-check-label" for="edit_takeaway">Asporto</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_delivery"
                                        name="features[]" value="Consegna">
